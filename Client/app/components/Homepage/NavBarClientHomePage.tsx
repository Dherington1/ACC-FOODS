                ...
                (
                    ...
                    <>
                        ...
                        {/* <Link href='/login' passHref>
                            <h2 className='text-custom-burgundy' style={{cursor: 'pointer', fontSize: '1.2rem'}}>Login</h2>
                        </Link>

                        <Link href='/register' passHref>
                            <h2 className='text-custom-burgundy' style={{cursor: 'pointer', fontSize: '1.2rem'}}>Register</h2>
                        </Link> */}
                    </>
                )}
        </>
