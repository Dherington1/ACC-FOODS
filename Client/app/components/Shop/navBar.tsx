...
const NavBar = () => {
    ...
    const handlePickedCategory = (event: React.MouseEvent<HTMLSpanElement, MouseEvent>, category: string) => {
    ...
    return (
        <>
            <div className="min-h-screen flex flex-row bg-gray-100 w-1/5">
                <div className="flex flex-col align-center w-4/5 bg-white overflow-hidden">
                    ...
                    <ul className="flex flex-col ml-10 py-4 align-center">
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Fruits & Vegetables')}>
                        ...
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Meat & Seafood')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                                    src='/fish.png' 
                        ...
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Dairy & Eggs')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                        ...
                        <li className='pl-8'  onClick={(e) => handlePickedCategory(e, 'Bakery & Bread')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                                    src='/breads.png' 
                        ...
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Beverages')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                                    src='/coffee.png' 
                        ...
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Snacks')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                                    src='/snack.png' 
                        ...
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Frozen Foods')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                                    src='/frozen.png' 
                        ...
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Spices & Herbs')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                                    src='/spices.png' 
                        ...
                        <li className='pl-8' onClick={(e) => handlePickedCategory(e, 'Condiments & Sauces')}>
                            <a href="" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-custom-lightGreen">
                            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"> 
                                <Image 
                                    src='/ketchup.png' 
            ...
            <ShopHeader name={clickedCategory} />
        </>
    )  
}
